...
(function(){
  ...
  const hotels={
    h1:{name:{ru:'Отель Золотой Колос',en:'Zolotoy Kolos Hotel',hi:'Zolotoy Kolos Hotel'},city:{ru:'Москва',en:'Moscow',hi:'मॉस्को'},top:{ru:'Москва · 7,4 км от центра',en:'Moscow · 7.4 km from the centre',hi:'मॉस्को · केंद्र से 7.4 किमी'},meta:{ru:'Отель · 923 отзыва',en:'Hotel · 923 reviews',hi:'होटल · 923 समीक्षाएँ'},rating:8.5,price:3616,url:'https://hotel.tutu.ru/h_meblirovannye_komnaty_zolotoy_kolos/'},
    h2:{name:{ru:'Меблированные комнаты Симфония Уюта',en:'Simfoniya Uyuta Furnished Rooms',hi:'Simfoniya Uyuta Furnished Rooms'},city:{ru:'Санкт-Петербург',en:'Saint Petersburg',hi:'सेंट पीटर्सबर्ग'},top:{ru:'Санкт-Петербург · 2,1 км от центра',en:'Saint Petersburg · 2.1 km from the centre',hi:'सेंट पीटर्सबर्ग · केंद्र से 2.1 किमी'},meta:{ru:'Отель · 78 отзывов',en:'Hotel · 78 reviews',hi:'होटल · 78 समीक्षाएँ'},rating:9.3,price:1348,url:'https://hotel.tutu.ru/h_gostevoy_dom_simfoniya_uyuta/'},
    h3:{name:{ru:'Мини-отель Стерео',en:'Stereo Mini-Hotel',hi:'Stereo Mini-Hotel'},city:{ru:'Казань',en:'Kazan',hi:'कज़ान'},top:{ru:'Казань · 1,5 км от центра',en:'Kazan · 1.5 km from the centre',hi:'कज़ान · केंद्र से 1.5 किमी'},meta:{ru:'Мини-отель · 158 отзывов',en:'Mini-hotel · 158 reviews',hi:'मिनी-होटल · 158 समीक्षाएँ'},rating:8.4,price:2080,url:'https://hotel.tutu.ru/c_russia/kazan/'},
    h4:{name:{ru:'Номера в Твери',en:'Nomera v Tveri',hi:'Nomera v Tveri'},city:{ru:'Тверь',en:'Tver',hi:'त्वेर'},top:{ru:'Тверь · 2,4 км от центра',en:'Tver · 2.4 km from the centre',hi:'त्वेर · केंद्र से 2.4 किमी'},meta:{ru:'Отель · 127 отзывов',en:'Hotel · 127 reviews',hi:'होटल · 127 समीक्षाएँ'},rating:9.0,price:2799,url:'https://hotel.tutu.ru/c_russia/tver/'},
    h5:{name:{ru:'Отель Zебра',en:'Zebra Hotel',hi:'Zebra Hotel'},city:{ru:'Йошкар-Ола',en:'Yoshkar-Ola',hi:'योश्कर-ओला'},top:{ru:'Йошкар-Ола · 2,2 км от центра',en:'Yoshkar-Ola · 2.2 km from the centre',hi:'योश्कर-ओला · केंद्र से 2.2 किमी'},meta:{ru:'Отель · 86 отзывов',en:'Hotel · 86 reviews',hi:'होटल · 86 समीक्षाएँ'},rating:8.8,price:2340,url:'https://hotel.tutu.ru/c_russia/yoshkar_ola/'},
    h6:{name:{ru:'Дача Хаус',en:'Dacha House',hi:'Dacha House'},city:{ru:'Ростов-на-Дону',en:'Rostov-on-Don',hi:'रोस्तोव-ऑन-डॉन'},top:{ru:'Ростов-на-Дону · 3,4 км от центра',en:'Rostov-on-Don · 3.4 km from the centre',hi:'रोस्तोव-ऑन-डॉन · केंद्र से 3.4 किमी'},meta:{ru:'Отель · 46 отзывов',en:'Hotel · 46 reviews',hi:'होटल · 46 समीक्षाएँ'},rating:7.8,price:2400,url:'https://hotel.tutu.ru/c_russia/rostov_na_donu/'},
    h7:{name:{ru:'Hotel Amax Inn',en:'Hotel Amax Inn',hi:'Hotel Amax Inn'},city:{ru:'Нью-Дели',en:'New Delhi',hi:'नई दिल्ली'},top:{ru:'Нью-Дели · 3 км от центра',en:'New Delhi · 3 km from the centre',hi:'नई दिल्ली · केंद्र से 3 किमी'},meta:{ru:'Отель',en:'Hotel',hi:'होटल'},rating:null,price:1293,url:'https://hotel.tutu.ru/h_hotel_amax_inn/'}
  };
  ...
  if(hotelRow){
    ...
    Object.entries(hotels).forEach(([id,d])=>{
      ...
      if(price){
        ...
        if(lang==='ru')price.innerHTML='<span class="price">от '+nf(d.price)+' ₽ <span class="hotel-night">'+night+'</span></span><span class="price-alt">≈ ₹'+nf(inr)+'</span>';
        ...
        else price.innerHTML='<span class="price">from ₹'+nf(inr)+' <span class="hotel-night">'+night+'</span></span><span class="price-alt">≈ '+nf(d.price)+' ₽</span>';
      }
      activate(card,d.url);
    });
