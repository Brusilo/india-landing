...
(function(){
  ...
  const hotels={
    ...
    h5:{name:{ru:'АМАКС Сити-отель Йошкар-Ола',en:'AMAKS City Hotel Yoshkar-Ola',hi:'AMAKS City Hotel Yoshkar-Ola'},city:{ru:'Йошкар-Ола',en:'Yoshkar-Ola',hi:'योश्कर-ओला'},top:{ru:'Йошкар-Ола · 1 км от центра',en:'Yoshkar-Ola · 1 km from the centre',hi:'योश्कर-ओला · केंद्र से 1 किमी'},meta:{ru:'Отель 3★ · 752 отзыва',en:'3-star hotel · 752 reviews',hi:'3-स्टार होटल · 752 समीक्षाएँ'},rating:8.1,price:2995,url:'https://hotel.tutu.ru/h_amaks_siti_otel_yoshkarola/'},
