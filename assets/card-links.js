...
(function(){
  ...
  const hotels={
    ...
    h3:{name:'Хостел Автор Таганка',city:{ru:'Москва',en:'Moscow',hi:'मॉस्को'},top:{ru:'Москва · 3 км от центра',en:'Moscow · 3 km from the centre',hi:'मॉस्को · केंद्र से 3 किमी'},meta:{ru:'Хостел · 336 отзывов',en:'Hostel · 336 reviews',hi:'हॉस्टल · 336 समीक्षाएँ'},rating:'8,4',price:3178,url:'https://hotel.tutu.ru/h_khostel_avtor/'},
    ...
    h5:{name:'Гостевые комнаты и апартаменты Грифон',city:{ru:'Санкт-Петербург',en:'Saint Petersburg',hi:'सेंट पीटर्सबर्ग'},top:{ru:'Санкт-Петербург · 894 м от центра',en:'Saint Petersburg · 894 m from the centre',hi:'सेंट पीटर्सबर्ग · केंद्र से 894 मी'},meta:{ru:'Апартаменты',en:'Apartments',hi:'अपार्टमेंट'},rating:'',price:2400,url:'https://hotel.tutu.ru/h_gostevye_komnaty_i_apartamenty_grifon/'},
