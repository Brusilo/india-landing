...
(function(){
  ...
  const hotels={
    ...
    h3:{name:{ru:'Мини-отель На Набережной',en:'Na Naberezhnoy Mini-Hotel',hi:'Na Naberezhnoy Mini-Hotel'},city:{ru:'Казань',en:'Kazan',hi:'कज़ान'},top:{ru:'Казань · 1,5 км от центра',en:'Kazan · 1.5 km from the centre',hi:'कज़ान · केंद्र से 1.5 किमी'},meta:{ru:'Мини-отель · 64 отзыва',en:'Mini-hotel · 64 reviews',hi:'मिनी-होटल · 64 समीक्षाएँ'},rating:8.2,price:2000,url:'https://hotel.tutu.ru/h_miniotel_na_naberezhnoy_kazan/'},
    h4:{name:{ru:'Номера в Твери',en:'Nomera v Tveri',hi:'Nomera v Tveri'},city:{ru:'Тверь',en:'Tver',hi:'त्वेर'},top:{ru:'Тверь · 2,4 км от центра',en:'Tver · 2.4 km from the centre',hi:'त्वेर · केंद्र से 2.4 किमी'},meta:{ru:'Отель · 126 отзывов',en:'Hotel · 126 reviews',hi:'होटल · 126 समीक्षाएँ'},rating:9.0,price:2499,url:'https://hotel.tutu.ru/h_otel_sweet_home_tver/'},
    h5:{name:{ru:'Отель Zебра',en:'Zebra Hotel',hi:'Zebra Hotel'},city:{ru:'Йошкар-Ола',en:'Yoshkar-Ola',hi:'योश्कर-ओला'},top:{ru:'Йошкар-Ола · 2,2 км от центра',en:'Yoshkar-Ola · 2.2 km from the centre',hi:'योश्कर-ओला · केंद्र से 2.2 किमी'},meta:{ru:'Отель · 86 отзывов',en:'Hotel · 86 reviews',hi:'होटल · 86 समीक्षाएँ'},rating:8.8,price:2100,url:'https://hotel.tutu.ru/h_zebra_rossiya_424004_resp_mary_el_g_yoshkarola_ul_vodoprovodnaya_d_48/'},
    h6:{name:{ru:'Меблированные комнаты Альфа',en:'Alfa Furnished Rooms',hi:'Alfa Furnished Rooms'},city:{ru:'Ростов-на-Дону',en:'Rostov-on-Don',hi:'रोस्तोव-ऑन-डॉन'},top:{ru:'Ростов-на-Дону · 7,4 км от центра',en:'Rostov-on-Don · 7.4 km from the centre',hi:'रोस्तोव-ऑन-डॉन · केंद्र से 7.4 किमी'},meta:{ru:'Отель · 103 отзыва',en:'Hotel · 103 reviews',hi:'होटल · 103 समीक्षाएँ'},rating:8.1,price:1736,url:'https://hotel.tutu.ru/h_gostevoy_dom_alfa_rostovnadonu/'},
