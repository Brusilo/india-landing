/* Yandex.Metrika: shared by the Russian, English and Hindi landing pages. */
(function () {
  'use strict';
  if (window.__tutuMetrika112759004Initialized) return;
  ...
  window.ym(112759004, 'init', {ssr:true, webvisor:true, clickmap:true, ecommerce:"dataLayer", referrer: document.referrer, url: location.href, accurateTrackBounce:true, trackLinks:true});
  window.__tutuMetrika112759004Initialized = true;
})();
